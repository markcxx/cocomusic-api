...
import { lyricPlatforms, platforms } from "@/components/playground/constants";
...
export default function LyricEndpointPanel({
  platform,
  songId,
  onPlatformChange,
  onSongIdChange,
    ...
    <>
      <div className="flex flex-col gap-3">
        <label className="text-xs font-bold text-zinc-700 dark:text-zinc-300">
          歌曲 ID / MID <span className="text-red-500">*</span>
        </label>
      ...
      <PlatformDropdown
        ...
        isDisabled={(value) => !lyricPlatforms.includes(value)}
        helperText="歌词获取当前开放 QQ 音乐与网易云音乐。"
      />
    </>
  );
}
