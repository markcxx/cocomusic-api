  ...
  return (
    <aside className="bg-surface-container-low dark:bg-inverse-surface border-r border-outline-variant dark:border-outline h-full w-64 left-0 hidden md:flex flex-col p-base gap-2 z-10 shrink-0">
      ...
      <nav className="flex-1 flex flex-col gap-1">
        <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2 bg-secondary-container dark:bg-on-secondary-fixed-variant text-on-secondary-container dark:text-secondary-fixed font-semibold rounded-xl scale-95 transition-transform">
