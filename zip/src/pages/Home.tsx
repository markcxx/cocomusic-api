        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center w-full max-w-7xl mx-auto">
            <div className="space-y-8 z-10">
              ...
              >
                <Link to="/playground" className="h-12 px-8 bg-zinc-900 dark:bg-white text-white dark:text-zinc-950 font-bold rounded-lg hover:scale-105 transition-transform flex items-center gap-2 shadow-lg">
                  立即体验 <ArrowRight className="w-4 h-4" />
                </Link>
                <Link to="/docs" className="h-12 px-8 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 font-bold rounded-lg hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 transition-colors flex items-center gap-2">
                  ...
                  <div className="w-1/3 h-16 bg-zinc-200 dark:bg-zinc-900 rounded border-2 border-zinc-300 dark:border-zinc-800 flex items-center justify-center z-10 overflow-hidden relative shadow-inner">
                    ...
                    >
                      <div className="flex items-center gap-1 opacity-50 px-4">
                        {[...Array(50)].map((_, i) => (
                           <div key={i} className="w-1 bg-zinc-800 dark:bg-zinc-500 rounded-full" style={{ height: `${20 + (Math.sin(i) * 30 + 30)}%` }}></div>
                        ))}
                      </div>
                    </motion.div>
                  </div>
